...
export default function NutriBotScreen() {
    const [messages, setMessages] = useState<Message[]>([
        {
            id: '1',
            text: "Hi! I'm NutriBot, your AI nutrition coach. I've analyzed your eating patterns and I'm here to help you reach your health goals. How can I assist you today?",
            sender: 'bot',
            timestamp: new Date(),
        },
    ]);
    ...
    const sendMessage = async () => {
        ...
        if (!authUser) {
            Alert.alert('Login Required', 'Please login to chat with NutriBot.');
            return;
        }
        ...
        try {
            ...
            // Get AI response
            const aiResponse = await chatWithNutriBot(currentInput, chatHistory, userContext);
                ...
                >
                    ...
                    {isTyping && (
                        <View style={[styles.messageBubble, styles.botBubble]}>
                            ...
                            <Text style={styles.typingText}>NutriBot is typing...</Text>
                        </View>
                    )}
                </ScrollView>
